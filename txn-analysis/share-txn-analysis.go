...
func main() {
    ...
    _, err = f.WriteString("Date,Stock,Exchange,Type,Demat,Action,Quantity,Price,Value,Brokerage,STT,Transaction Charges,GST,Stamp Duty,Buy Date,Buy Cost,COA,P/L,Days,P/L Type\n")
